            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 pb-safe">
                ...
                <button
                  ...
                  onClick={onClose}
                  disabled={submitting}
                  className="w-full rounded-md border px-4 py-2.5 text-sm font-medium text-foreground hover:bg-muted transition-colors disabled:pointer-events-none disabled:opacity-50"
                >
